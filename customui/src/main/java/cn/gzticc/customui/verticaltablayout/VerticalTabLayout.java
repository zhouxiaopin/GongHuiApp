package cn.gzticc.customui.verticaltablayout;
...
import cn.gzticc.customui.R;
import cn.gzticc.customui.verticaltablayout.adapter.TabAdapter;
import cn.gzticc.customui.verticaltablayout.util.DisplayUtil;
import cn.gzticc.customui.verticaltablayout.util.TabFragmentManager;
import cn.gzticc.customui.verticaltablayout.widget.QTabView;
...
public class VerticalTabLayout extends ScrollView {
    ...
    private void addTabWithMode(TabView tabView) {
        ...
        if (mTabStrip.indexOfChild(tabView) == 0) {
            ...
            params.setMargins(10, mTabMargin, 10, mTabMargin);
            params.height = 0;
            params.weight = 1.0f;
